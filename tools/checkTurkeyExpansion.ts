...
for (const outlet of turkeyOutlets) {
  ...
  assert(
    outlet.outletId === "viaport-asia-outlet-shopping" ? outletBrandRelations.length === 188 : outlet.outletId === "olivium-outlet-center" ? outletBrandRelations.length === 95 : outlet.outletId === "starcity-outlet" ? outletBrandRelations.length === 101 : outlet.outletId === "optimum-premium-outlet-istanbul" ? outletBrandRelations.length === 112 : outlet.outletId === "izmir-optimum" ? outletBrandRelations.length === 195 : outlet.outletId === "212-outlet" ? outletBrandRelations.length === 106 : outlet.outletId === "venezia-mega-outlet" ? outletBrandRelations.length === 128 : outlet.outletId === "deepo-outlet-center" ? outletBrandRelations.length === 171 : outletBrandRelations.length === 0,
...
assert(outletBrands.filter((relation) => relation.outletId === "venezia-mega-outlet").length === 128, "Venezia must retain 127 verified relations.");
