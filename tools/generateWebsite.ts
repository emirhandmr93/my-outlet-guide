...
function page(
  ...
  return `<!doctype html><html lang="tr"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>${esc(title)} | My Outlet Guide</title><meta name="description" content="${esc(intro)}"><link rel="stylesheet" href="/assets/styles.css"></head><body class="app-screen"><header class="app-topbar"><nav class="app-topbar-nav"><a class="brand app-logo-lockup" href="/"><span class="brand-mark" aria-hidden="true"><svg viewBox="0 0 32 32"><path d="M8 12h16l-1 13H9L8 12Z"/><path d="M12 12a4 4 0 0 1 8 0"/><path d="m16 15 1.8 3.5 3.8.5-2.8 2.7.7 3.8-3.5-1.8-3.5 1.8.7-3.8-2.8-2.7 3.8-.5L16 15Z"/></svg></span><span>MY OUTLET GUIDE</span></a><div class="links">${nav}</div><a class="nav-app" href="/app/" aria-label="Uygulama durumu">⇩ <span>Uygulama</span></a></nav><section class="hero app-hero-card"><p class="pill app-pill">${eyebrow}</p><h1>${h1}</h1><p>${intro}</p></section></header><main>${body}</main>${footer}</body></html>`;
}
...
const homePage = (body: string) => `<!doctype html><html lang="tr"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Outlet keşfi | My Outlet Guide</title><meta name="description" content="Premium outletleri keşfet, daha çok tasarruf et ve sonraki alışveriş seyahatini planla."><link rel="stylesheet" href="/assets/styles.css"></head><body class="home-page app-screen"><header class="home-header app-topbar" style="background-image:linear-gradient(90deg,rgba(4,19,39,.96) 0%,rgba(8,29,56,.82) 47%,rgba(8,29,56,.45) 100%),url('${asset("home/home-hero-premium.png")}')"><nav class="home-nav app-topbar-nav"><a class="home-menu-button" href="/explore/" aria-label="Menüyü aç">☰</a><a class="brand app-logo-lockup" href="/"><span class="brand-mark" aria-hidden="true"><svg viewBox="0 0 32 32"><path d="M8 12h16l-1 13H9L8 12Z"/><path d="M12 12a4 4 0 0 1 8 0"/><path d="m16 15 1.8 3.5 3.8.5-2.8 2.7.7 3.8-3.5-1.8-3.5 1.8.7-3.8-2.8-2.7 3.8-.5L16 15Z"/></svg></span><span>MY OUTLET GUIDE</span></a><div class="links home-links"><a class="is-active" href="/" aria-current="page">Ana Sayfa</a><a href="/explore/">Keşfet</a><a href="/outlets/">Outletler</a><a href="/tax-free/">Tax Free</a><a href="/trip-planner/">Seyahat Planı</a><a href="/flight-deals/">Uçuş Uyarıları</a><a href="/app/">Uygulama</a></div><div class="home-utility-actions"><a class="home-icon-button" href="/app/" aria-label="Bildirimler">🔔</a><a class="nav-app" href="/app/" aria-label="Dil ve uygulama durumu">🇹🇷 <span>TR</span></a></div></nav><section class="hero home-main-hero app-hero-card app-image-card"><div class="home-hero-brand"><span class="brand-mark" aria-hidden="true"><svg viewBox="0 0 32 32"><path d="M8 12h16l-1 13H9L8 12Z"/><path d="M12 12a4 4 0 0 1 8 0"/><path d="m16 15 1.8 3.5 3.8.5-2.8 2.7.7 3.8-3.5-1.8-3.5 1.8.7-3.8-2.8-2.7 3.8-.5L16 15Z"/></svg></span><p class="pill app-pill">PREMIUM ALIŞVERİŞ VE SEYAHAT ASİSTANI</p></div><h1>My Outlet Guide’a hoş geldin</h1><p>Premium outletleri keşfet, daha çok tasarruf et ve sonraki alışveriş seyahatini planla.</p></section><a class="home-search app-search-pill" href="/explore/" aria-label="Şehir, outlet ve marka ara"><b>⌕</b> <span>Şehir, outlet ve marka ara</span><em>Keşfet →</em></a><div class="home-hero-actions"><a class="home-primary-cta" href="/explore/">Outletleri keşfet <b>→</b></a><a class="home-status-chip" href="/app/">App Store incelemesi bekleniyor</a><a class="home-status-chip" href="/app/">Google Play hazırlıkta</a></div></header><main class="home-main"><div class="home-content home-wide-container app-screen app-page">${body}</div>${appTabs}</main>${footer}<script src="/assets/home-carousel.js" defer></script></body></html>`;
