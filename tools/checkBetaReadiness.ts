...
assert(read("tools/checkExternalLinksReadiness.ts").includes("External links readiness checks passed.") && read("src/constants/externalLinks.ts").includes("INSTAGRAM_HANDLE = \"@myoutletguide\""), "external links readiness checker exists and centralizes Instagram handle");
