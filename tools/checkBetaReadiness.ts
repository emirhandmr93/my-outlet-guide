...
assert(offlineScreen.includes('t("offline.noPacksTitle")') && translations.includes('"profile.subtitles.offlinePacks": "Uygulamayla gelen rehber verileri"') && translations.includes('"offline.noPacksText": "Bu sürümde ayrıca indirilebilir paket yoktur. Hesaba bağlı veriler ve canlı servisler internet gerektirir."'), "OfflinePacks does not claim downloadable packs");
