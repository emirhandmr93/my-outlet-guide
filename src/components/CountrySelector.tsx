...
const desktopFlags: Record<string, FlagArtwork> = {
  ...
  china: { ratio: 1.5, svg: flag(1.5, '<rect width="100%" height="100%" fill="#de2910"/><g fill="#ffde00"><path d="M.24.12l.04.12h.12l-.1.07.04.12-.1-.07-.1.07.04-.12-.1-.07h.12z"/><circle cx=".48" cy=".16" r=".04"/><circle cx=".57" cy=".27" r=".04"/><circle cx=".56" cy=".4" r=".04"/><circle cx=".45" cy=".48" r=".04"/></g>') },
