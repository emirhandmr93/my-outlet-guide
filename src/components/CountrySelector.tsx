...
const desktopFlags: Record<string, FlagArtwork> = {
  ...
  china: { ratio: 1.5, svg: flag(1.5, '<rect width="100%" height="100%" fill="#de2910"/><g fill="#ffde00"><path d="M.24.12l.04.12h.12l-.1.07.04.12-.1-.07-.1.07.04-.12-.1-.07h.12z"/><path d="M.48.12l.01.03h.03l-.025.018.01.03-.025-.018-.025.018.01-.03-.025-.018h.03zM.57.23l.01.03h.03l-.025.018.01.03-.025-.018-.025.018.01-.03-.025-.018h.03zM.56.36l.01.03h.03l-.025.018.01.03-.025-.018-.025.018.01-.03-.025-.018h.03zM.45.44l.01.03h.03l-.025.018.01.03-.025-.018-.025.018.01-.03-.025-.018h.03z"/></g>') },
  ...
  spain: { ratio: 1.5, svg: flag(1.5, '<rect width="100%" height="25%" fill="#aa151b"/><rect y="25%" width="100%" height="50%" fill="#f1bf00"/><rect y="75%" width="100%" height="25%" fill="#aa151b"/><path d="M.28.34h.12v.32H.28z" fill="#aa151b" stroke="#fff" stroke-width=".025"/>') },
  ...
  "united-states": { ratio: 19 / 10, svg: flag(19 / 10, '<rect width="100%" height="100%" fill="#fff"/><path d="M0 0h1.9v.077H0zm0 .154h1.9v.077H0zm0 .308h1.9v.077H0zm0 .462h1.9v.077H0zm0 .616h1.9v.077H0zm0 .77h1.9v.077H0zm0 .924h1.9V1H0z" fill="#b22234"/><rect width=".76" height=".54" fill="#3c3b6e"/><g fill="#fff"><circle cx="0.08" cy="0.06" r=".018"/><circle cx="0.20" cy="0.06" r=".018"/><circle cx="0.32" cy="0.06" r=".018"/><circle cx="0.44" cy="0.06" r=".018"/><circle cx="0.56" cy="0.06" r=".018"/><circle cx="0.68" cy="0.06" r=".018"/><circle cx="0.80" cy="0.06" r=".018"/><circle cx="0.92" cy="0.06" r=".018"/><circle cx="1.04" cy="0.06" r=".018"/><circle cx="1.16" cy="0.06" r=".018"/><circle cx="0.08" cy="0.15" r=".018"/><circle cx="0.20" cy="0.15" r=".018"/><circle cx="0.32" cy="0.15" r=".018"/><circle cx="0.44" cy="0.15" r=".018"/><circle cx="0.56" cy="0.15" r=".018"/><circle cx="0.68" cy="0.15" r=".018"/><circle cx="0.80" cy="0.15" r=".018"/><circle cx="0.92" cy="0.15" r=".018"/><circle cx="1.04" cy="0.15" r=".018"/><circle cx="1.16" cy="0.15" r=".018"/><circle cx="0.08" cy="0.24" r=".018"/><circle cx="0.20" cy="0.24" r=".018"/><circle cx="0.32" cy="0.24" r=".018"/><circle cx="0.44" cy="0.24" r=".018"/><circle cx="0.56" cy="0.24" r=".018"/><circle cx="0.68" cy="0.24" r=".018"/><circle cx="0.80" cy="0.24" r=".018"/><circle cx="0.92" cy="0.24" r=".018"/><circle cx="1.04" cy="0.24" r=".018"/><circle cx="1.16" cy="0.24" r=".018"/><circle cx="0.08" cy="0.33" r=".018"/><circle cx="0.20" cy="0.33" r=".018"/><circle cx="0.32" cy="0.33" r=".018"/><circle cx="0.44" cy="0.33" r=".018"/><circle cx="0.56" cy="0.33" r=".018"/><circle cx="0.68" cy="0.33" r=".018"/><circle cx="0.80" cy="0.33" r=".018"/><circle cx="0.92" cy="0.33" r=".018"/><circle cx="1.04" cy="0.33" r=".018"/><circle cx="1.16" cy="0.33" r=".018"/><circle cx="0.08" cy="0.42" r=".018"/><circle cx="0.20" cy="0.42" r=".018"/><circle cx="0.32" cy="0.42" r=".018"/><circle cx="0.44" cy="0.42" r=".018"/><circle cx="0.56" cy="0.42" r=".018"/><circle cx="0.68" cy="0.42" r=".018"/><circle cx="0.80" cy="0.42" r=".018"/><circle cx="0.92" cy="0.42" r=".018"/><circle cx="1.04" cy="0.42" r=".018"/><circle cx="1.16" cy="0.42" r=".018"/></g>') },
};
