...
export function FlightSearchScreen() {
  ...
  const narrowWebDates = Platform.OS === "web" && width <= 360;
  ...
  return <>
    <ScrollView style={styles.screen} contentContainerStyle={[styles.content, desktop && styles.desktop, { paddingTop: desktop ? 32 : getScreenTopInset(insets.top), paddingBottom: desktop ? 32 : getFloatingTabClearance(insets.bottom) }]} scrollIndicatorInsets={{ bottom: getScrollIndicatorBottomInset(insets.bottom) }} keyboardShouldPersistTaps="handled">
      ...
      <View style={styles.card}>
        ...
        <View style={[styles.dateRow, isNativeRTL && styles.rowReverse, narrowWebDates && styles.dateRowNarrow]}>
          ...
          >
            ...
            >
              <View style={styles.modalHeader}>
                ...
                <TextInput accessibilityLabel={t("flightSearch.airportSearch")} value={filterText} onChangeText={setFilterText} placeholder={t("flightSearch.airportSearch")} placeholderTextColor={colors.textMuted} style={[styles.input, Platform.OS === "web" && styles.inputWeb, isNativeRTL && styles.rtlText]} />
              </View>
