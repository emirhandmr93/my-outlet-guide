...
export function ReviewModerationScreen() {
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      ...
      <TextInput style={[styles.noteInput, Platform.OS === "web" && styles.inputWeb, isNativeRTL && styles.proseInputRTL]} value={note} onChangeText={setNote} placeholder={t("moderation.note")} />
      {cards.map((group) => {
