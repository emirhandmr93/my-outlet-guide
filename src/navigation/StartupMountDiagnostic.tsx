...
const HomeFeaturedRecommendedNoMetrics = () => <HomeScreen diagnosticMode="featured-recommended-no-metrics" />;
const HomeDelayedFeaturedNoMetrics = () => <HomeScreen diagnosticMode="delayed-featured-no-metrics" />;
const HomeFeaturedRecommendedNoImages = () => <HomeScreen diagnosticMode="featured-recommended-no-images" />;
const HomeDelayedFeaturedNoImages = () => <HomeScreen diagnosticMode="delayed-featured-no-images" />;
const HomeFeaturedRecommendedOneItem = () => <HomeScreen diagnosticMode="featured-recommended-one-item" />;
const HomeLightweightAllCarousels = () => <HomeScreen diagnosticMode="lightweight-all-carousels" />;
const homeDiagnosticComponents: Record<HomeMountDiagnosticMode, typeof HomeScreen> = {
  ...
  "featured-recommended-no-metrics": HomeFeaturedRecommendedNoMetrics,
  "delayed-featured-no-metrics": HomeDelayedFeaturedNoMetrics,
  "featured-recommended-no-images": HomeFeaturedRecommendedNoImages,
  "delayed-featured-no-images": HomeDelayedFeaturedNoImages,
  "featured-recommended-one-item": HomeFeaturedRecommendedOneItem,
  "lightweight-all-carousels": HomeLightweightAllCarousels,
};
...
const imageMeasurementChoices: Array<[Stage, string, HomeMountDiagnosticMode]> = [
  ["home-featured-recommended-no-metrics", "Featured + Recommended — no metrics", "featured-recommended-no-metrics"],
  ["home-delayed-featured-no-metrics", "Delayed Featured — no metrics", "delayed-featured-no-metrics"],
  ["home-featured-recommended-no-images", "Featured + Recommended — no images", "featured-recommended-no-images"],
  ["home-delayed-featured-no-images", "Delayed Featured — no images", "delayed-featured-no-images"],
  ["home-featured-recommended-one-item", "Featured + Recommended — one item", "featured-recommended-one-item"],
  ["home-lightweight-all-carousels", "Lightweight all carousels", "lightweight-all-carousels"],
];
