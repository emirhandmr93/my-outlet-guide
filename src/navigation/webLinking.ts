...
export const WEB_ROUTE_DEFINITIONS: readonly WebRouteDefinition[] = [
  ...
  { name: "OutletDetail", path: "outlet/:outletId", parameter: "outletId" }, { name: "VisitMode", path: "visit/:outletId", parameter: "outletId" }, { name: "BrandResults", path: "brand/:brandId", parameter: "brandId" }, { name: "Country", path: "country/:countryId", parameter: "countryId" }, { name: "CityResults", path: "city/:cityId", parameter: "cityId" }, { name: "Transportation", path: "transportation/:outletId", parameter: "outletId" },
  { name: "MyTripsList", path: "trips/my-trips" }, { name: "NearbyOutlets", path: "nearby-outlets" }, { name: "OutletMatch", path: "outlet-match/:selection", parameter: "selection" }, { name: "Favorites", path: "favorites" }, { name: "BrandWishlist", path: "brand-wishlist" }, { name: "CreateTrip", path: "trips/create" }, { name: "TripDetail", path: "trip/:tripId", parameter: "tripId" }, { name: "TripSegmentEditor", path: "trip/:tripId/edit", parameter: "tripId" },
  ...
  { name: "WriteReview", path: "outlet/:outletId/review", parameter: "outletId" }, { name: "PremiumOutletMap", path: "outlet/:outletId/3d-map", parameter: "outletId" }, { name: "FlightSearch", path: "flights/search" }, { name: "FlightDealSettings", path: "flight-deals/settings" }, { name: "FlightDeals", path: "flight-deals" }, { name: "FlightDealDetail", path: "flight-deals/:dealId", parameter: "dealId" }, { name: "CampaignDetail", path: "campaign/:campaignId", parameter: "campaignId" }, { name: "TravelBasket", path: "travel-basket" },
