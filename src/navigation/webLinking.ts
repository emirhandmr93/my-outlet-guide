...
export const WEB_ROUTE_DEFINITIONS: readonly WebRouteDefinition[] = [
  ...
  { name: "WriteReview", path: "outlet/:outletId/review", parameter: "outletId" }, { name: "FlightSearch", path: "flights/search" }, { name: "FlightDealSettings", path: "flight-deals/settings" }, { name: "FlightDeals", path: "flight-deals" }, { name: "FlightDealDetail", path: "flight-deals/:dealId", parameter: "dealId" }, { name: "TravelBasket", path: "travel-basket" },
