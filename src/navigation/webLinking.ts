...
export const WEB_ROUTE_DEFINITIONS: readonly WebRouteDefinition[] = [
  ...
  { name: "MyTripsList", path: "trips/my-trips" }, { name: "NearbyOutlets", path: "nearby-outlets" }, { name: "Favorites", path: "favorites" }, { name: "BrandWishlist", path: "brand-wishlist" }, { name: "CreateTrip", path: "trips/create" }, { name: "TripDetail", path: "trip/:tripId", parameter: "tripId" }, { name: "TripSegmentEditor", path: "trip/:tripId/edit", parameter: "tripId" },
