...
export const brandsFK: Brand[] = [
  ...
  { brandId: "felisi", brandName: "Felisi", aliases: [], categoryId: "fashion", logo: "", luxuryLevel: "lifestyle", rankingWeight: 50, brandStatus: "active" },
  ...
  { brandId: "gunze-outlet", brandName: "GUNZE OUTLET", aliases: [], categoryId: "fashion", logo: "", luxuryLevel: "lifestyle", rankingWeight: 50, brandStatus: "active" },
  { brandId: "hawkins-and-vans", brandName: "HAWKINS & VANS", aliases: [], categoryId: "fashion", logo: "", luxuryLevel: "lifestyle", rankingWeight: 50, brandStatus: "active" },
  ...
  { brandId: "hat-shop-outlet", brandName: "Hat Shop OUTLET", aliases: [], categoryId: "fashion", logo: "", luxuryLevel: "lifestyle", rankingWeight: 50, brandStatus: "active" },
  { brandId: "hunting-world", brandName: "HUNTING WORLD", aliases: [], categoryId: "fashion", logo: "", luxuryLevel: "lifestyle", rankingWeight: 50, brandStatus: "active" },
  { brandId: "gregory", brandName: "GREGORY", aliases: [], categoryId: "fashion", logo: "", luxuryLevel: "lifestyle", rankingWeight: 50, brandStatus: "active" },
  { brandId: "feiler", brandName: "FEILER Factory Outlet", aliases: [], categoryId: "fashion", logo: "", luxuryLevel: "lifestyle", rankingWeight: 50, brandStatus: "active" },
  { brandId: "john-masters-organics-select", brandName: "john masters organics select", aliases: [], categoryId: "fashion", logo: "", luxuryLevel: "lifestyle", rankingWeight: 50, brandStatus: "active" },
  { brandId: "kate-spade-new-york-kids", brandName: "kate spade new york kids", aliases: [], categoryId: "fashion", logo: "", luxuryLevel: "lifestyle", rankingWeight: 50, brandStatus: "active" },
  { brandId: "garmin", brandName: "GARMIN", aliases: [], categoryId: "fashion", logo: "", luxuryLevel: "lifestyle", rankingWeight: 50, brandStatus: "active" },
  { brandId: "instant-skateboards", brandName: "Instant Skateboards", aliases: [], categoryId: "fashion", logo: "", luxuryLevel: "lifestyle", rankingWeight: 50, brandStatus: "active" },
  ...
  { brandId: "kisarazu-concept-store", brandName: "KISARAZU CONCEPT STORE", aliases: [], categoryId: "fashion", logo: "", luxuryLevel: "lifestyle", rankingWeight: 50, brandStatus: "active" },
  { brandId: "kaldi-coffee-farm", brandName: "KALDI COFFEE FARM", aliases: [], categoryId: "food-chocolate", logo: "", luxuryLevel: "lifestyle", rankingWeight: 50, brandStatus: "active" },
];
