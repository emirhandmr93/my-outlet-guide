export const germanyRestaurants = [
  {
    ...
    priceLevel: "€",
    website:
      "https://www.cityoutletbadmuenstereifel.com/en/plan-a-visit/gastronomy/",
    status: "active",
    displayOrder: "1",
  },
  {
  ...
  },
  {
    ...
    priceLevel: "€€",
    website:
      "https://www.mcarthurglen.com/en/outlets/de/designer-outlet-neumuenster/food-drink/",
    status: "active",
    displayOrder: "1",
  },
  {
  ...
  },
  {
    ...
    priceLevel: "€€€",
    website:
      "https://www.thebicestercollection.com/ingolstadt-village/en/dine/",
    status: "active",
    displayOrder: "1",
  },
  {
  ...
  {
    restaurantId: "halle-leipzig-the-style-outlets-coffee-fellows",
  ...
  {
    restaurantId: "halle-leipzig-the-style-outlets-frittenwerk",
    outletId: "halle-leipzig-the-style-outlets",
    restaurantName: "FRITTENWERK",
    category: "Fries • Street Food",
    priceLevel: "€€",
    website: "https://halle.leipzig.thestyleoutlets.de/en/restaurants",
    status: "active",
    displayOrder: "2",
  ...
  {
    restaurantId: "halle-leipzig-the-style-outlets-global-doner",
    outletId: "halle-leipzig-the-style-outlets",
    restaurantName: "GLOBAL DÖNER",
    category: "Döner • Quick Service",
    priceLevel: "€",
    website: "https://halle.leipzig.thestyleoutlets.de/en/restaurants",
    status: "active",
    displayOrder: "3",
  ...
  {
    restaurantId: "halle-leipzig-the-style-outlets-mamalicious",
    outletId: "halle-leipzig-the-style-outlets",
    restaurantName: "MAMALICIOUS",
    category: "Restaurant",
    priceLevel: "€€",
    website: "https://halle.leipzig.thestyleoutlets.de/en/restaurants",
    status: "active",
  ...
  {
    restaurantId: "halle-leipzig-the-style-outlets-starbucks",
    outletId: "halle-leipzig-the-style-outlets",
    restaurantName: "STARBUCKS",
    category: "Coffee",
    priceLevel: "€€",
