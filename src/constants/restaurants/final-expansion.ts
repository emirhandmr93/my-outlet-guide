const diningSources: Record<string, { source: string; names: string[] }> = {
  ...
  "wrentham-village-premium-outlets": { source: "https://www.premiumoutlets.com/outlet/wrentham-village/about", names: ["Tavern in the Square", "Shake Shack", "Big Chicken", "Aroma Joe's", "Cracker Barrel"] },
  ...
  "las-americas-premium-outlets": { source: "https://www.premiumoutlets.com/outlet/las-americas/stores/print", names: ["Achiote", "Al Chile", "Famous Wok", "IHOP", "Jamba Juice", "McDonald's", "Nori Japan", "Panda Express", "Sbarro", "Starbucks Coffee", "The Coffee Bean & Tea Leaf", "Tantuni", "Wetzel's Pretzels"] },
