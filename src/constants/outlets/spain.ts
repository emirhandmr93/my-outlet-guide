export const spainOutlets = [
  ...
  },
  {
    ...
    taxFreeOfficeInfo: "Eligible non-EU visitors should confirm tax-free availability at the Infopoint or with participating stores and validate export documents when leaving the EU.",
    cityCenterDistanceKm: 15,
    airportDistanceKm: 6,
