export const unitedArabEmiratesOutlets = [
  ...
  },
  {
    ...
    countryId: "united-arab-emirates",
    cityId: "dubai",
    address: "The Outlet Village, Dubai Parks and Resorts, Jebel Ali, Dubai, United Arab Emirates",
    latitude: 24.95813,
    longitude: 55.0517,
    ...
    heroImage: "",
    galleryImages: [],
    storesCountText: "More than 100 premium labels and stores (500+ brands represented across the destination)",
    rating: 0,
    reviewCount: 0,
    services: [
      "ATM",
    ...
    airports: [
      { code: "DXB", name: "Dubai International Airport", distanceKm: 54 },
