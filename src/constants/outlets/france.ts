export const franceOutlets = [
  ...
  },
  {
    ...
    estimatedRefundRate: 12,
    minimumTaxFreeSpend: "100.01 EUR",
    taxFreeOperator: "Global Blue / Planet / PABLO customs validation",
    taxFreeOfficeInfo: "Eligible non-EU visitors, including guests from the UK excluding Northern Ireland, can request a tax refund form in participating boutiques when spending more than €100. Validate forms with customs or a PABLO kiosk when leaving the EU, then claim the refund through airport reimbursement desks or by mailing documents to Global Blue or Planet.",
  ...
  },
  {
    ...
    heroImage: "",
    galleryImages: [],
    storesCountText: "more than 100 leading brands",
    rating: 0,
    reviewCount: 0,
    services: [
      "Parking",
    ...
    estimatedRefundRate: 12,
    minimumTaxFreeSpend: "100.01 EUR",
    taxFreeOperator: "The Style Outlets tax-free service / EU customs validation",
    taxFreeOfficeInfo: "Eligible non-EU visitors can request tax-free shopping support through the centre's Tax Free service and validate export documents when leaving the EU.",
  ...
  } as any,
  {
    ...
    name: "Paris-Giverny Designer Outlet",
    slug: "paris-giverny-designer-outlet",
    countryId: "france",
    cityId: "douains",
    address: "1 Avenue du Capitaine Vandière de Vitrac, 27120 Douains, France",
    latitude: 49.0417,
    longitude: 1.4356,
    openingHours: "Mon-Fri 10:00 - 19:00; Sat 09:30 - 21:00; Sun 09:30 - 20:00",
    heroImage: "",
    galleryImages: [],
    storesCountText: "Over 80 stores",
    rating: 0,
    reviewCount: 0,
    services: ["Free Parking", "Guest Services", "Restaurants & Cafes", "Tourism", "Gift Card", "Shuttle", "The Second Life", "Free Wi-Fi", "Luggage Lockers", "EV Charging", "Accessibility", "Transport Info"],
    restaurants: ["Amorino", "As du Pick", "Bollicine&Co.", "Five Guys", "La Ruche", "Ladurée", "Les Hortensias", "Lindt", "Obicà", "YUMI"],
    parking: "Official services list free parking throughout the centre with no time limits, plus more than 120 electric car charging stations subject to availability and fees.",
    taxFreeAvailable: true,
    vatRate: 20,
    estimatedRefundRate: 12,
    minimumTaxFreeSpend: "100.01 EUR",
    taxFreeOperator: "Participating stores / EU customs validation",
    taxFreeOfficeInfo: "Guests visiting from outside the EU can receive a tax refund on purchases; confirm participating store process and validate export documents when leaving the EU.",
    cityCenterDistanceKm: 75,
    airportDistanceKm: 85,
    airports: [{ code: "ORY", name: "Paris Orly Airport", distanceKm: 85 }, { code: "CDG", name: "Paris Charles de Gaulle Airport", distanceKm: 95 }],
    cityCenterInfo: { name: "Paris City Centre", distanceKm: 75, recommendedRoute: "Use car, shuttle, or rail via Vernon-Giverny with onward local transport." },
    websiteUrl: "https://www.mcarthurglen.com/en/outlets/fr/designer-outlet-paris-giverny/",
    status: "active",
    googleMapsUrl: "https://www.google.com/maps/search/?api=1&query=Paris-Giverny+Designer+Outlet",
