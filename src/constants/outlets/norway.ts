export const norwayOutlets = [
  {
    ...
    minimumTaxFreeSpend: "315 NOK",
    taxFreeOperator: "Participating tax refund operators",
    taxFreeOfficeInfo: "Eligible non-Norway visitors can request tax-free shopping assistance at participating stores and validate documents when leaving Norway.",
