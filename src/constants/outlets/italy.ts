export const italyOutlets = [
  ...
  } as any,
  {
    ...
    heroImage: "",
    galleryImages: [],
    storesCountText: "More than 100 stores",
    rating: 0,
    reviewCount: 0,
    ...
    parking: "ROS lists 3,000 parking spaces for Mantova Village; confirm current parking details on the official website before visiting.",
    taxFreeAvailable: true,
    vatRate: 22,
    estimatedRefundRate: 12,
    minimumTaxFreeSpend: "70.01 EUR",
