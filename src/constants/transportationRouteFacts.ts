...
export const transportationRouteFacts: TransportationRouteFact[] = [
  ...
  },
  {
    ...
    provider: "ATVO",
    operator: "ATVO",
    boardingPoint: "Mestre Bus Terminal – Railway Station",
    destination: "Noventa di Piave Designer Outlet",
    estimatedFareMin: 9.2,
    estimatedFareMax: 9.2,
    currency: "EUR",
  ...
  },
  {
    ...
    provider: "ATVO",
    operator: "ATVO",
    boardingPoint: "Venice Marco Polo Airport",
    destination: "Noventa di Piave Designer Outlet",
    estimatedFareMin: 9.2,
    estimatedFareMax: 9.2,
    currency: "EUR",
  ...
  },
  {
    ...
    boardingPoint: "Milan S13 network",
  ...
  },
  {
    ...
    provider: "GTT / SFM",
    operator: "GTT / SFM",
    line: "Tram 4 / SFM 1, 2, 4, 6 or 7 / GTT SE1 or SE2",
    boardingPoint: "Turin city centre / Torino Lingotto / Torino Porta Susa / Torino Rebaudengo",
    transferPoints: ["Torino Stura"],
