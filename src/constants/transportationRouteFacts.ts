...
export const transportationRouteFacts: TransportationRouteFact[] = [
  ...
  {
    guideId: "rotterdam-to-roosendaal-train-bus", outletId: "designer-outlet-roosendaal", originType: "cityCenter", mode: "train", provider: "NS / Bravo", operator: "NS / Bravo", line: "Rotterdam Centraal → Roosendaal", boardingPoint: "Rotterdam Centraal", alightingPoint: "Roosendaal", transferPoints: ["161 / 164 → Designer Outlet Roosendaal"], destination: "Designer Outlet Roosendaal", suppressDerivedDurationFallback: true, sourceNote: "The official outlet publishes a separate approximately five-minute bus segment from Roosendaal Station and currently lists routes 161 and 164; check current NS and Bravo times before travel.", confidence: "exact", officialProviderUrl: "https://www.mcarthurglen.com/en/outlets/nl/designer-outlet-roosendaal/services/",
  },
  {
