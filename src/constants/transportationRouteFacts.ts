...
export const transportationRouteFacts: TransportationRouteFact[] = [
  ...
  {
    guideId: "saarbrucken-city-center-to-zweibrucken-fashion-outlet", outletId: "zweibrucken-fashion-outlet", originType: "cityCenter", mode: "train", provider: "DB / VRN / Stadtbus Zweibrücken", operator: "DB / VRN / Stadtbus Zweibrücken", line: "Saarbrücken Hbf → Zweibrücken → Stadtbus", boardingPoint: "Saarbrücken Hbf", alightingPoint: "Zweibrücken Fashion Outlet", destination: "Zweibrücken Fashion Outlet", suppressDerivedDurationFallback: true, sourceNote: "Use the current DB/VRN journey planner from Saarbrücken to Zweibrücken. VIA Outlets publishes an hourly city bus connection between Zweibrücken and the outlet Monday through Saturday; verify the current line, stop and transfer before travel.", confidence: "partial", officialProviderUrl: "https://www.viaoutlets.com/portfolio/zweibrucken-fashion-outlet",
  },
  {
