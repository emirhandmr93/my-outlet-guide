...
export const transportationRouteFacts: TransportationRouteFact[] = [
  ...
  {
    guideId: "rotterdam-to-roosendaal-train-bus", outletId: "designer-outlet-roosendaal", originType: "cityCenter", mode: "train", provider: "NS / Bravo", operator: "NS / Bravo", line: "Rotterdam Centraal → Roosendaal", boardingPoint: "Rotterdam Centraal", alightingPoint: "Roosendaal", transferPoints: ["161 → Designer Outlet Roosendaal"], destination: "Designer Outlet Roosendaal", suppressDerivedDurationFallback: true, sourceNote: "Current Bravo route information lists Line 161 between Roosendaal Station and Designer Outlet Roosendaal; check current NS and Bravo times before travel.", confidence: "exact", officialProviderUrl: "https://bravo.info/dienstregeling-buslijnen-regio-roosendaal",
  },
  {
    guideId: "amsterdam-centraal-to-amsterdam-style-outlets-train-walk", outletId: "amsterdam-the-style-outlets", originType: "cityCenter", mode: "train", provider: "NS", operator: "NS", line: "Amsterdam Centraal → Halfweg-Zwanenburg", boardingPoint: "Amsterdam Centraal", alightingPoint: "Halfweg-Zwanenburg", destination: "Amsterdam The Style Outlets", walkNote: "Halfweg-Zwanenburg has a direct pedestrian connection to Amsterdam The Style Outlets.", suppressDerivedDurationFallback: true, sourceNote: "The official outlet publishes an approximately 10-minute train position from Amsterdam Centraal and a direct station connection; do not present this as a verified door-to-door duration.", confidence: "exact", officialProviderUrl: "https://amsterdam.thestyleoutlets.nl/en/how-to-get-there",
  },
  {
    guideId: "amsterdam-to-batavia-stad-train-bus", outletId: "batavia-stad-fashion-outlet", originType: "cityCenter", mode: "train", provider: "NS / RRReis", operator: "NS / RRReis", line: "Amsterdam Centraal → Lelystad Centrum", boardingPoint: "Amsterdam Centraal", alightingPoint: "Lelystad Centrum", transferPoints: ["13 → Batavia Stad"], destination: "Batavia Stad Fashion Outlet", suppressDerivedDurationFallback: true, sourceNote: "Use the current NS connection to Lelystad Centrum and the current RRReis Line 13 connection to Batavia Stad; check both operators before travel.", confidence: "partial", officialProviderUrl: "https://www.rrreis.nl/lelystad",
  },
  {
  ...
  },
  {
    ...
    suppressDerivedDurationFallback: true,
    sourceNote: "Daily service from Strasbourg FS; reservation required.",
    confidence: "exact",
  ...
  },
  {
    ...
    suppressDerivedDurationFallback: true,
    sourceNote: "Direct service operates Friday through Sunday; current booking terms apply.",
    confidence: "exact",
  ...
  },
  {
    ...
    suppressDerivedDurationFallback: true,
    sourceNote: "Bus 5101 serves One Nation Paris Outlet as its first stop from Villepreux-les-Clayes; a published 10-minute walk is the alternative.",
    confidence: "exact",
