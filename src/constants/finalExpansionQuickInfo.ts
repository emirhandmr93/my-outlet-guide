...
const rows: Record<string, { hours: keyof typeof hours; city: string; count: string; services: string[] }> = {
  ...
  "camarillo-premium-outlets": { hours: "daily1020", city: "Los Angeles / Camarillo", count: "160+ stores", services: ["Customer Service", "Dining", "Parking"] },
  ...
  "citadel-outlets": { hours: "daily1021", city: "Los Angeles", count: "Outlet shopping centre", services: ["Customer Service", "Dining", "Parking"] },
