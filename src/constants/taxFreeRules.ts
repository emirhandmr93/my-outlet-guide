...
export const taxFreeRules: TaxFreeRule[] = [
  ...
  { countryCode: "AT", countryName: "Austria", countryId: "austria", currency: "EUR", vatRate: 20, minimumPurchaseStatus: "not_verified", refundPolicy: { mode: "provider_dependent_upper_bound", source: euSchemeSource }, schemeSource: euSchemeSource, vatRateSource: euVatSource, notes: euNotes },
  { countryCode: "BE", countryName: "Belgium", countryId: "belgium", currency: "EUR", vatRate: 21, minimumPurchaseStatus: "not_verified", refundPolicy: { mode: "provider_dependent_upper_bound", source: euSchemeSource }, schemeSource: euSchemeSource, vatRateSource: euVatSource, notes: euNotes },
  { countryCode: "BG", countryName: "Bulgaria", countryId: "bulgaria", currency: "EUR", vatRate: 20, minimumPurchaseStatus: "not_verified", refundPolicy: { mode: "provider_dependent_upper_bound", source: euSchemeSource }, schemeSource: euSchemeSource, vatRateSource: euVatSource, notes: euNotes },
  { countryCode: "HR", countryName: "Croatia", countryId: "croatia", currency: "EUR", vatRate: 25, minimumPurchaseStatus: "not_verified", refundPolicy: { mode: "provider_dependent_upper_bound", source: euSchemeSource }, schemeSource: euSchemeSource, vatRateSource: euVatSource, notes: euNotes },
  { countryCode: "CZ", countryName: "Czech Republic", countryId: "czech-republic", currency: "CZK", vatRate: 21, minimumPurchaseStatus: "not_verified", refundPolicy: { mode: "provider_dependent_upper_bound", source: euSchemeSource }, schemeSource: euSchemeSource, vatRateSource: euVatSource, notes: euNotes },
  { countryCode: "DK", countryName: "Denmark", countryId: "denmark", currency: "DKK", vatRate: 25, minimumPurchaseStatus: "not_verified", refundPolicy: { mode: "provider_dependent_upper_bound", source: euSchemeSource }, schemeSource: euSchemeSource, vatRateSource: euVatSource, notes: euNotes },
  { countryCode: "EE", countryName: "Estonia", countryId: "estonia", currency: "EUR", vatRate: 24, minimumPurchaseStatus: "not_verified", refundPolicy: { mode: "provider_dependent_upper_bound", source: euSchemeSource }, schemeSource: euSchemeSource, vatRateSource: euVatSource, notes: euNotes },
  { countryCode: "FI", countryName: "Finland", countryId: "finland", currency: "EUR", vatRate: 25.5, minimumPurchaseStatus: "not_verified", refundPolicy: { mode: "provider_dependent_upper_bound", source: euSchemeSource }, schemeSource: euSchemeSource, vatRateSource: euVatSource, notes: euNotes },
  ...
  { countryCode: "DE", countryName: "Germany", countryId: "germany", currency: "EUR", vatRate: 19, minimumPurchaseStatus: "not_verified", refundPolicy: { mode: "provider_dependent_upper_bound", source: euSchemeSource }, schemeSource: euSchemeSource, vatRateSource: euVatSource, notes: euNotes },
  { countryCode: "GR", countryName: "Greece", countryId: "greece", currency: "EUR", vatRate: 24, minimumPurchaseStatus: "not_verified", refundPolicy: { mode: "provider_dependent_upper_bound", source: euSchemeSource }, schemeSource: euSchemeSource, vatRateSource: euVatSource, notes: euNotes },
  { countryCode: "HU", countryName: "Hungary", countryId: "hungary", currency: "HUF", vatRate: 27, minimumPurchaseStatus: "not_verified", refundPolicy: { mode: "provider_dependent_upper_bound", source: euSchemeSource }, schemeSource: euSchemeSource, vatRateSource: euVatSource, notes: euNotes },
  { countryCode: "IE", countryName: "Ireland", countryId: "ireland", currency: "EUR", vatRate: 23, minimumPurchaseStatus: "not_verified", refundPolicy: { mode: "provider_dependent_upper_bound", source: euSchemeSource }, schemeSource: euSchemeSource, vatRateSource: euVatSource, notes: euNotes },
  ...
  { countryCode: "LV", countryName: "Latvia", countryId: "latvia", currency: "EUR", vatRate: 21, minimumPurchaseStatus: "not_verified", refundPolicy: { mode: "provider_dependent_upper_bound", source: euSchemeSource }, schemeSource: euSchemeSource, vatRateSource: euVatSource, notes: euNotes },
  { countryCode: "LT", countryName: "Lithuania", countryId: "lithuania", currency: "EUR", vatRate: 21, minimumPurchaseStatus: "not_verified", refundPolicy: { mode: "provider_dependent_upper_bound", source: euSchemeSource }, schemeSource: euSchemeSource, vatRateSource: euVatSource, notes: euNotes },
  { countryCode: "NL", countryName: "Netherlands", countryId: "netherlands", currency: "EUR", vatRate: 21, minimumPurchaseStatus: "not_verified", refundPolicy: { mode: "provider_dependent_upper_bound", source: euSchemeSource }, schemeSource: euSchemeSource, vatRateSource: euVatSource, notes: euNotes },
  { countryCode: "PL", countryName: "Poland", countryId: "poland", currency: "PLN", vatRate: 23, minimumPurchaseStatus: "not_verified", refundPolicy: { mode: "provider_dependent_upper_bound", source: euSchemeSource }, schemeSource: euSchemeSource, vatRateSource: euVatSource, notes: euNotes },
  ...
  { countryCode: "RO", countryName: "Romania", countryId: "romania", currency: "RON", vatRate: 19, minimumPurchaseStatus: "not_verified", refundPolicy: { mode: "provider_dependent_upper_bound", source: euSchemeSource }, schemeSource: euSchemeSource, vatRateSource: euVatSource, notes: euNotes },
  { countryCode: "SK", countryName: "Slovakia", countryId: "slovakia", currency: "EUR", vatRate: 23, minimumPurchaseStatus: "not_verified", refundPolicy: { mode: "provider_dependent_upper_bound", source: euSchemeSource }, schemeSource: euSchemeSource, vatRateSource: euVatSource, notes: euNotes },
  { countryCode: "ES", countryName: "Spain", countryId: "spain", currency: "EUR", vatRate: 21, minimumPurchaseStatus: "not_verified", refundPolicy: { mode: "provider_dependent_upper_bound", source: euSchemeSource }, schemeSource: euSchemeSource, vatRateSource: euVatSource, notes: euNotes },
  { countryCode: "SE", countryName: "Sweden", countryId: "sweden", currency: "SEK", vatRate: 25, minimumPurchaseStatus: "not_verified", refundPolicy: { mode: "provider_dependent_upper_bound", source: euSchemeSource }, schemeSource: euSchemeSource, vatRateSource: euVatSource, notes: euNotes },
  ...
  { countryCode: "AE", countryName: "United Arab Emirates", countryId: "united-arab-emirates", currency: "AED", vatRate: 5, minimumPurchaseStatus: "not_verified", refundPolicy: { mode: "provider_dependent_upper_bound", source: { url: "https://u.ae/en/information-and-services/finance-and-investment/taxation/vat/tax-refund-for-tourists", name: "UAE Government Portal", checkedDate } }, schemeSource: { url: "https://u.ae/en/information-and-services/finance-and-investment/taxation/vat/tax-refund-for-tourists", name: "UAE Government Portal", checkedDate }, vatRateSource: { url: "https://u.ae/en/information-and-services/finance-and-investment/taxation/vat/tax-refund-for-tourists", name: "UAE Government Portal", checkedDate }, notes: "Official UAE tourist VAT refund guidance; retailer participation and final refund conditions apply." },
];
