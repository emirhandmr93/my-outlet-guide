...
export const taxFreeRules: TaxFreeRule[] = [
  ...
  { countryCode: "IT", countryName: "Italy", countryId: "italy", currency: "EUR", vatRate: 22, minimumPurchaseAmount: 70.01, minimumPurchaseBasis: "gross", minimumPurchaseComparison: "at_least", minimumPurchaseStatus: "verified_amount", refundEstimateMode: "maximum_vat_component", sourceUrl: euVatRatesUrl, sourceName: "European Commission — VAT rates", effectiveDate: checkedDate, notes: euNotes },
  ...
  { countryCode: "CH", countryName: "Switzerland", countryId: "switzerland", currency: "CHF", vatRate: 8.1, minimumPurchaseAmount: 300, minimumPurchaseBasis: "gross", minimumPurchaseComparison: "at_least", minimumPurchaseStatus: "verified_amount", refundEstimateMode: "maximum_vat_component", sourceUrl: "https://www.estv.admin.ch/en/vat-rates-switzerland", sourceName: "Swiss Federal Tax Administration", effectiveDate: checkedDate, notes: "Swiss tax-free shopping threshold and VAT conditions must be confirmed with the retailer." },
  { countryCode: "NO", countryName: "Norway", countryId: "norway", currency: "NOK", vatRate: 25, minimumPurchaseStatus: "not_verified", refundEstimateMode: "maximum_vat_component", sourceUrl: "https://www.skatteetaten.no/en/business-and-organisation/vat-and-duties/vat/foreign-visitors/", sourceName: "Norwegian Tax Administration", effectiveDate: checkedDate, notes: "Official Norwegian Tax Administration tourist VAT refund guidance; no numeric minimum is modeled without a verified source." },
  { countryCode: "TR", countryName: "Turkey", countryId: "turkey", currency: "TRY", vatRate: 20, minimumPurchaseStatus: "not_verified", refundEstimateMode: "maximum_vat_component", sourceUrl: "https://www.trade.gov.tr/gumruk-islemleri/sikca-sorulan-sorular/yolcu-beraberi-esya", sourceName: "Republic of Türkiye Ministry of Trade", effectiveDate: checkedDate, notes: "Official Ministry of Trade traveller guidance confirms the scheme. No numeric purchase threshold is modeled because the current authoritative material reviewed does not clearly support a calculator threshold basis." },
