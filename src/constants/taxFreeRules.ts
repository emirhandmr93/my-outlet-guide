...
export const taxFreeRules: TaxFreeRule[] = [
  ...
  { countryCode: "NL", countryName: "Netherlands", countryId: "netherlands", currency: "EUR", vatRate: 21, minimumPurchaseStatus: "no_statutory_minimum", refundPolicy: { mode: "provider_dependent_upper_bound", source: { url: "https://www.belastingdienst.nl/wps/wcm/connect/bldcontentnl/belastingdienst/zakelijk/btw/zakendoen_met_het_buitenland/zakendoen_buiten_de_eu/btw_berekenen/btw_berekenen_bij_export_van_goederen_naar_niet_eu_landen/export_door_particulier_die_buiten_de_eu_woont", name: "Dutch Tax and Customs Administration", checkedDate } }, schemeSource: { url: "https://www.belastingdienst.nl/wps/wcm/connect/bldcontentnl/belastingdienst/zakelijk/btw/zakendoen_met_het_buitenland/zakendoen_buiten_de_eu/btw_berekenen/btw_berekenen_bij_export_van_goederen_naar_niet_eu_landen/export_door_particulier_die_buiten_de_eu_woont", name: "Dutch Tax and Customs Administration", checkedDate }, vatRateSource: euVatSource, notes: "Dutch Tax and Customs Administration guidance does not model a statutory positive minimum purchase threshold; retailer proof and eligibility conditions still apply." },
