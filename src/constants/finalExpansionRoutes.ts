...
export const finalExpansionRoutes: ExpansionRoute[] = [
  ...
  {
    guideId: "los-angeles-to-camarillo-premium-outlets-car", outletId: "camarillo-premium-outlets", originType: "city_center", originId: "los-angeles", mode: "uber", provider: "Licensed taxi / ride-hailing",
    legs: [{ line: "US-101", fromStop: "Los Angeles City Centre", toStop: "Camarillo Premium Outlets" }], durationMin: 55, durationMax: 100, fareMin: 80, fareMax: 160, currency: "USD", fareAccuracy: "estimated", fareUnit: "vehicle", officialProviderUrl: "https://www.premiumoutlets.com/outlet/camarillo", notes: ["taxiQuote"], recommended: true, checkedAt: "2026-09-14", sources: ["https://www.premiumoutlets.com/outlet/camarillo"], fareBasis: "Per-vehicle planning range only; live quote, traffic and demand determine the actual fare."
  },
  {
  ...
  {
    guideId: "downtown-la-to-citadel-outlets-car", outletId: "citadel-outlets", originType: "city_center", originId: "los-angeles", mode: "uber", provider: "Licensed taxi / ride-hailing",
    legs: [{ line: "I-5 / local access", fromStop: "Downtown Los Angeles", toStop: "Citadel Outlets" }], durationMin: 15, durationMax: 35, fareMin: 20, fareMax: 45, currency: "USD", fareAccuracy: "estimated", fareUnit: "vehicle", officialProviderUrl: "https://www.citadeloutlets.com/", notes: ["taxiQuote"], recommended: true, checkedAt: "2026-09-14", sources: ["https://www.citadeloutlets.com/"], fareBasis: "Per-vehicle planning range; live quote, traffic and demand determine the actual fare."
  },
  {
