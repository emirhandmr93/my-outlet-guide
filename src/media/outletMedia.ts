...
export function getOutletMediaImages(outlet: OutletMediaOutlet): OutletMediaImage[] {
...
export function getOutletHeroImage(outlet: OutletMediaOutlet): OutletMediaImage | undefined {
