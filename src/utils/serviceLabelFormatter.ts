const serviceLabelKeys: Record<string, string> = {
  ...
  "shuttle / transport info": "service.label.shuttleTransportInfo",
  "private transfer": "service.label.privateTransfer",
  "camper parking area": "service.label.camperParkingArea",
