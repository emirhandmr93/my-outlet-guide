...
const outletRetailCountTranslations: Record<TranslationLanguage, Record<string, string>> = {
  ...
  tr: { "sharedCards.quickFacts.brands": "Markalar", "sharedCards.quickFacts.boutiques": "Butikler", "sharedCards.quickFacts.listedBrands": "Listelenen markalar", "sharedCards.quickFacts.retailCount": "Perakende sayısı", "outlet.retailCount.notVerified": "Sayı doğrulanmadı", "outlet.retailCount.qualifier.exact": "{count}", "outlet.retailCount.qualifier.plus": "{count}+", "outlet.retailCount.qualifier.more_than": "{count}'D fazla", "outlet.retailCount.qualifier.almost": "Yaklaşık {count}", "outlet.retailCount.qualifier.about": "Yaklaşık {count}", "outlet.retailCount.qualifier.up_to": "En fazla {count}" },
  ...
  fr: { "sharedCards.quickFacts.brands": "Marques", "sharedCards.quickFacts.boutiques": "Boutiques", "sharedCards.quickFacts.listedBrands": "Marques répertoriées", "sharedCards.quickFacts.retailCount": "Nombre de commerces", "outlet.retailCount.notVerified": "Nombre non vérifié", "outlet.retailCount.qualifier.exact": "{count}", "outlet.retailCount.qualifier.plus": "{count}+", "outlet.retailCount.qualifier.more_than": "Plus de {count}", "outlet.retailCount.qualifier.almost": "Près de {count}", "outlet.retailCount.qualifier.about": "Environ {count}", "outlet.retailCount.qualifier.up_to": "Jusqu’à {count}" },
