...
> = {
  ...
  tr: {
    ...
    "offline.alreadyAvailableText": "Uygulama yüklendikten sonra paketli outlet detayları, marka listeleri, restoranlar, ulaşım notları, yerel outlet fotoğrafları ve desteklenen Tax Free kuralları gezilebilir.",
    ...
    "offline.available.guide.title": "Outlet rehber verileri",
    "offline.available.guide.text": "Outlet detayları ve ülke kapsamı uygulamayla birlikte gelir.",
    "offline.available.records.title": "Markalar, restoranlar ve ulaşım notları",
    "offline.available.records.text": "Marka kayıtları, restoran kayıtları ve ulaşım notları yerel olarak paketlenir.",
    "offline.available.media.title": "Yerel outlet fotoğrafları",
    "offline.available.media.text": "Üretim için güvenli outlet görselleri uygulama paketindedir ve ağ isteği gerektirmez.",
    "offline.available.taxFree.title": "Tax Free kuralları",
    "offline.available.taxFree.text": "Desteklenen ülkeler için kaynaklı Tax Free kayıtları uygulamayla gelir.",
    "offline.requires.reviews.title": "Yorumlar ve puanlar",
    "offline.requires.reviews.text": "Yorum listeleri, yorum yazma, faydalı oyları ve raporlar Firestore desteklidir ve internet gerektirir.",
    "offline.requires.favoritesTrips.title": "Favoriler ve seyahat eşitlemesi",
    ...
    "offline.requires.notifications.title": "Bildirimler ve uçuş uyarıları",
    "offline.requires.notifications.text": "Anlık bildirim token kaydı, hatırlatma ayarları ve uçuş uyarıları ağ destekli altyapı gerektirir.",
    "offline.requires.currency.title": "Döviz çevirici",
    ...
    "offline.noPacksText": "Bu sürüm ayrı seyahat paketi indirmez. Kayıtlı seyahatler ve favoriler eşitleme için internet gerektirir.",
...
const betaSupportLegalTranslations: Record<TranslationLanguage, Record<string, string>> = {
  en: {
    ...
    "offline.available.guide.title": "Outlet guide data",
    "offline.available.guide.text": "Outlet details and country coverage are bundled with the app.",
    "offline.available.records.title": "Brands, restaurants and transportation notes",
    "offline.available.records.text": "Brand records, restaurant records and transportation notes are packaged locally.",
    "offline.available.media.title": "Local outlet photos",
    ...
    "offline.available.taxFree.title": "Tax Free rules",
    "offline.available.taxFree.text": "Source-backed Tax Free records are bundled for supported countries.",
    "offline.requires.reviews.title": "Reviews and ratings",
    "offline.requires.reviews.text": "Review lists, review writes, helpful votes and reports are Firestore-backed and require network access.",
    "offline.requires.favoritesTrips.title": "Favorites and trips sync",
    ...
    "offline.requires.notifications.title": "Notifications and flight alerts",
    "offline.requires.notifications.text": "Push token registration, reminder settings and flight alerts require network-backed infrastructure.",
    "offline.requires.currency.title": "Currency converter",
...
const finalBetaBlockerTranslations: Record<TranslationLanguage, Record<string, string>> = {
  ...
  tr: {
    ...
    "offline.title": "Çevrimdışı Kullanım",
    "offline.subtitle": "Temel rehber verileri uygulamayla birlikte gelir. Bu sürümde ayrıca indirilebilir çevrimdışı paket yok.",
    "offline.alreadyAvailable": "İnternetsiz kullanılabilir",
    "offline.alreadyAvailableText": "Temel rehber verileri uygulamayla birlikte gelir. Outlet detayları, marka listeleri, ulaşım notları, yerel outlet fotoğrafları ve desteklenen Tax Free kuralları gezilebilir.",
    "offline.availableSection": "İnternetsiz kullanılabilir",
    "offline.requiresInternetSection": "İnternet gerektirir",
    "offline.noPacksTitle": "Çevrimdışı Kullanım",
    "offline.noPacksText": "Bu sürümde ayrı paket indirme yoktur.",
    "offline.available.records.text": "Marka kayıtları, restoran kayıtları ve ulaşım notları uygulamayla birlikte gelir.",
    "profile.offlinePacks": "Çevrimdışı Kullanım",
    "profile.subtitles.offlinePacks": "Uygulamayla gelen rehber verileri",
