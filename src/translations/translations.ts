...
Object.assign(liveCurrencyWeatherTranslations.ar, liveCurrencyWeatherTranslations.en, { "currency.liveRate": "سعر مباشر", "currency.liveUnavailable": "تعذر تحميل السعر المباشر.", "currency.amount": "المبلغ", "currency.convert": "تحويل", "weather.title": "الطقس", "weather.unavailable": "تعذر تحميل الطقس.", "weather.providerNotConfigured": "مزود الطقس غير مهيأ.", "weather.outOfRange": "التوقع غير متاح بعد.", "weather.missingCoordinates": "إحداثيات الطقس غير متوفرة لهذه المدينة." });
...
const returnFlightOutletWeatherSafetyTranslations: Record<TranslationLanguage, Record<string, string>> = {
  en: { "createTrip.returnFlightReminderTitle": "Return flight reminder", "createTrip.returnFlightReminderHelper": "If you choose a date and time, a reminder is created for your return flight.", "createTrip.returnFlightDate": "Return flight date", "createTrip.returnFlightTime": "Return flight time", "createTrip.returnFlightDateTimeRequired": "Return flight date and time must be entered together.", "weather.unavailable": "Weather could not be loaded.", "weather.providerNotConfigured": "Weather provider is not configured.", "weather.missingCoordinates": "Weather coordinates are missing for this outlet.", "weather.sourceOpenMeteo": "Source: Open-Meteo" },
  tr: { "createTrip.returnFlightReminderTitle": "Dönüş uçuş hatırlatması", "createTrip.returnFlightReminderHelper": "Tarih ve saat seçersen dönüş uçuşu için hatırlatma oluşturulur.", "createTrip.returnFlightDate": "Dönüş uçuş tarihi", "createTrip.returnFlightTime": "Dönüş uçuş saati", "createTrip.returnFlightDateTimeRequired": "Dönüş uçuş tarihi ve saati birlikte girilmeli.", "weather.unavailable": "Hava durumu alınamadı.", "weather.providerNotConfigured": "Hava durumu sağlayıcısı yapılandırılmadı.", "weather.missingCoordinates": "Bu outlet için hava durumu koordinatı eksik.", "weather.sourceOpenMeteo": "Kaynak: Open-Meteo" },
  es: { "createTrip.returnFlightReminderTitle": "Recordatorio de vuelo de regreso", "createTrip.returnFlightReminderHelper": "Si eliges fecha y hora, se creará un recordatorio para tu vuelo de regreso.", "createTrip.returnFlightDate": "Fecha del vuelo de regreso", "createTrip.returnFlightTime": "Hora del vuelo de regreso", "createTrip.returnFlightDateTimeRequired": "La fecha y la hora del vuelo de regreso deben introducirse juntas.", "weather.unavailable": "No se pudo cargar el tiempo.", "weather.providerNotConfigured": "El proveedor del tiempo no está configurado.", "weather.missingCoordinates": "Faltan coordenadas del tiempo para este outlet.", "weather.sourceOpenMeteo": "Fuente: Open-Meteo" },
  fr: { "createTrip.returnFlightReminderTitle": "Rappel de vol retour", "createTrip.returnFlightReminderHelper": "Si vous choisissez une date et une heure, un rappel est créé pour votre vol retour.", "createTrip.returnFlightDate": "Date du vol retour", "createTrip.returnFlightTime": "Heure du vol retour", "createTrip.returnFlightDateTimeRequired": "La date et l’heure du vol retour doivent être saisies ensemble.", "weather.unavailable": "Impossible de charger la météo.", "weather.providerNotConfigured": "Le fournisseur météo n’est pas configuré.", "weather.missingCoordinates": "Les coordonnées météo manquent pour cet outlet.", "weather.sourceOpenMeteo": "Source : Open-Meteo" },
  de: { "createTrip.returnFlightReminderTitle": "Rückflug-Erinnerung", "createTrip.returnFlightReminderHelper": "Wenn du Datum und Uhrzeit auswählst, wird eine Erinnerung für deinen Rückflug erstellt.", "createTrip.returnFlightDate": "Rückflugdatum", "createTrip.returnFlightTime": "Rückflugzeit", "createTrip.returnFlightDateTimeRequired": "Rückflugdatum und -zeit müssen zusammen eingegeben werden.", "weather.unavailable": "Wetter konnte nicht geladen werden.", "weather.providerNotConfigured": "Der Wetteranbieter ist nicht konfiguriert.", "weather.missingCoordinates": "Für dieses Outlet fehlen Wetterkoordinaten.", "weather.sourceOpenMeteo": "Quelle: Open-Meteo" },
  ar: { "createTrip.returnFlightReminderTitle": "تذكير رحلة العودة", "createTrip.returnFlightReminderHelper": "إذا اخترت التاريخ والوقت فسيتم إنشاء تذكير لرحلة العودة.", "createTrip.returnFlightDate": "تاريخ رحلة العودة", "createTrip.returnFlightTime": "وقت رحلة العودة", "createTrip.returnFlightDateTimeRequired": "يجب إدخال تاريخ ووقت رحلة العودة معًا.", "weather.unavailable": "تعذر تحميل الطقس.", "weather.providerNotConfigured": "مزود الطقس غير مهيأ.", "weather.missingCoordinates": "إحداثيات الطقس غير متوفرة لهذا الأوتلت.", "weather.sourceOpenMeteo": "المصدر: Open-Meteo" },
  ru: { "createTrip.returnFlightReminderTitle": "Напоминание об обратном рейсе", "createTrip.returnFlightReminderHelper": "Если выбрать дату и время, будет создано напоминание об обратном рейсе.", "createTrip.returnFlightDate": "Дата обратного рейса", "createTrip.returnFlightTime": "Время обратного рейса", "createTrip.returnFlightDateTimeRequired": "Дата и время обратного рейса должны быть указаны вместе.", "weather.unavailable": "Не удалось загрузить погоду.", "weather.providerNotConfigured": "Поставщик погоды не настроен.", "weather.missingCoordinates": "Для этого аутлета отсутствуют координаты погоды.", "weather.sourceOpenMeteo": "Источник: Open-Meteo" },
