...
const taxFreePolicyDisplayTranslations: Record<TranslationLanguage, Record<string, string>> = {
  en: {
    "taxFree.estimatedMaximumRefundRate": "Estimated maximum Tax Free refund rate", "taxFree.estimatedMaximumRefundRateValue": "Estimated maximum Tax Free refund rate: %{rate}", "taxFree.estimatedMaximumRefundRateBeforeFees": "Estimated maximum Tax Free refund rate: %{rate} before fees", "taxFree.method": "Tax Free method", "taxFree.maximumRateBasisExplanation": "This estimated maximum rate is calculated from the theoretical tax component contained in the gross price. The actual Tax Free refund may be lower depending on the retailer, provider, payment method, product class and processing fees.",
  ...
  tr: {
    "taxFree.estimatedMaximumRefundRate": "Tahmini azami Tax Free iade oranı", "taxFree.estimatedMaximumRefundRateValue": "Tahmini azami Tax Free iade oranı: %{rate}", "taxFree.estimatedMaximumRefundRateBeforeFees": "Tahmini azami Tax Free iade oranı: %{rate} (ücretler öncesi)", "taxFree.method": "Tax Free yöntemi", "taxFree.maximumRateBasisExplanation": "Bu tahmini azami oran, brüt fiyatın içindeki teorik vergi üst sınırından hesaplanır. Gerçek Tax Free iadesi mağaza, sağlayıcı, ödeme yöntemi, ürün sınıfı ve işlem ücretlerine göre daha düşük olabilir.",
  ...
  es: {
    "taxFree.estimatedMaximumRefundRate": "Tasa máxima estimada de reembolso Tax Free", "taxFree.estimatedMaximumRefundRateValue": "Tasa máxima estimada de reembolso Tax Free: %{rate}", "taxFree.estimatedMaximumRefundRateBeforeFees": "Tasa máxima estimada de reembolso Tax Free: %{rate} antes de comisiones", "taxFree.method": "Método Tax Free", "taxFree.maximumRateBasisExplanation": "Esta tasa máxima estimada se calcula a partir del componente fiscal teórico incluido en el precio bruto. El reembolso Tax Free real puede ser inferior según el comercio, proveedor, método de pago, clase de producto y comisiones de tramitación.",
  ...
  fr: {
    "taxFree.estimatedMaximumRefundRate": "Taux maximal estimé de remboursement Tax Free", "taxFree.estimatedMaximumRefundRateValue": "Taux maximal estimé de remboursement Tax Free : %{rate}", "taxFree.estimatedMaximumRefundRateBeforeFees": "Taux maximal estimé de remboursement Tax Free : %{rate} avant frais", "taxFree.method": "Méthode Tax Free", "taxFree.maximumRateBasisExplanation": "Ce taux maximal estimé est calculé à partir de la composante fiscale théorique incluse dans le prix brut. Le remboursement Tax Free réel peut être inférieur selon le commerçant, le prestataire, le moyen de paiement, la catégorie de produit et les frais de traitement.",
  ...
  de: {
    "taxFree.estimatedMaximumRefundRate": "Geschätzter maximaler Tax-Free-Erstattungssatz", "taxFree.estimatedMaximumRefundRateValue": "Geschätzter maximaler Tax-Free-Erstattungssatz: %{rate}", "taxFree.estimatedMaximumRefundRateBeforeFees": "Geschätzter maximaler Tax-Free-Erstattungssatz: %{rate} vor Gebühren", "taxFree.method": "Tax-Free-Methode", "taxFree.maximumRateBasisExplanation": "Dieser geschätzte Höchstsatz wird aus dem theoretischen Steueranteil im Bruttopreis berechnet. Die tatsächliche Tax-Free-Erstattung kann je nach Händler, Anbieter, Zahlungsmethode, Produktklasse und Bearbeitungsgebühren niedriger ausfallen.",
  ...
  zh: {
    "taxFree.estimatedMaximumRefundRate": "预计最高 Tax Free 退税率", "taxFree.estimatedMaximumRefundRateValue": "预计最高 Tax Free 退税率：%{rate}", "taxFree.estimatedMaximumRefundRateBeforeFees": "预计最高 Tax Free 退税率：%{rate}（费用前）", "taxFree.method": "Tax Free 方式", "taxFree.maximumRateBasisExplanation": "此预计最高比率根据含税总价中的理论税额计算。实际 Tax Free 退税可能因零售商、服务商、付款方式、商品类别和处理费用而更低。",
