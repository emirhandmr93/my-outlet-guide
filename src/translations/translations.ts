...
const appOnlyFeatureTranslations: Record<TranslationLanguage, Record<string, string>> = {
  en: { "appOnly.badge": "Mobile app", "appOnly.title": "Trip management is in the app", "appOnly.body": "You can view your trips on the web. Creating trips, changing dates and routes, and notification scheduling are managed in the mobile app.", "appOnly.helper": "App Store review is in progress. An open-in-app link will appear here when approval is complete.", "appOnly.cta": "Coming soon in the app", "appOnly.createBody": "Trip dates, routes, and notification scheduling are managed in the mobile app.", "appOnly.viewOnly": "Web is view-only. Changes and notification synchronization are handled in the mobile app.", "appOnly.notificationsTitle": "Notifications are managed in the app", "appOnly.notificationsBody": "Notification permissions, trip reminders, and device alerts are managed in the mobile app." },
